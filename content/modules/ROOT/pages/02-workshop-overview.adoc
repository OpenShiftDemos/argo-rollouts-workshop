...
In this workshop each user will have access to three OpenShift Projects as follows:
...
[NOTE]
Argo Rollouts can be deployed as either a namespace or cluster scope. The OpenShift GitOps operator currently only supports namespace scope.
...
https://developers.redhat.com/products/openshift-dev-spaces/overview[Red Hat OpenShift Dev Spaces] is a better choice.
====
