...
Here we will deploy the blue-green rollout in the `{user}-prod` namespace following the same process that we did for the Deployment in the previous module. Prior to starting,
...
.link:https://github.com/OpenShiftDemos/argo-rollouts-workshop/blob/main/content/modules/ROOT/examples/bluegreen/base/rollout.yaml[./bluegreen/base/rollout.yaml,window='_blank']
...
.link:https://github.com/OpenShiftDemos/argo-rollouts-workshop/blob/main/content/modules/ROOT/examples/bluegreen/base/services.yaml[./bluegreen/base/services.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
...
.link:https://github.com/OpenShiftDemos/argo-rollouts-workshop/blob/main/content/modules/ROOT/examples/bluegreen/base/routes.yaml[./bluegreen/base/routes.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
...
To access this pipeline, in the OpenShift Console navigate to the `{user}-tools` namespace and select
