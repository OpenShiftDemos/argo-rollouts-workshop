...
.link:https://dashboard-{user}-tools.{openshift_cluster_ingress_domain}[https://dashboard-{user}-tools.{openshift_cluster_ingress_domain}, window="_blank"]
...
[source,bash,subs="attributes+,+macros"]
----
oc get route -n {user}-prod preview -o jsonpath='{"https://"}{.spec.host}{"\n"}'
----
...
[source,bash,subs="attributes+,+macros"]
----
oc get route -n {user}-prod active -o jsonpath='{"https://"}{.spec.host}{"\n"}'
----
