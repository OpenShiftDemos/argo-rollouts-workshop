...
Now navigate to the link:Argo Rollouts Dashboard[https://dashboard-{user}-tools.{openshift_cluster_ingress_domain}, window="_blank"] and view the details of the application. Notice that the application
