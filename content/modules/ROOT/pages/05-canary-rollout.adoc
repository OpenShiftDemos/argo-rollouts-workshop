...
.link:https://github.com/OpenShiftDemos/argo-rollouts-workshop/blob/main/content/modules/ROOT/examples/canary/base/rollout.yaml[./canary/base/rollout.yaml,window='_blank']
...
.link:https://github.com/OpenShiftDemos/argo-rollouts-workshop/blob/main/content/modules/ROOT/examples/canary/base/services.yaml[./canary/base/services.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
...
.link:https://github.com/OpenShiftDemos/argo-rollouts-workshop/blob/main/content/modules/ROOT/examples/canary/base/routes.yaml[./canary/base/routes.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
...
[source,bash,subs="attributes+,+macros"]
----
oc get route -n {user}-prod stable -o jsonpath='{"https://"}{.spec.host}{"\n"}'
----
...
[source,bash,subs="attributes+,+macros"]
----
oc get route -n {user}-tools dashboard -o jsonpath='{"https://"}{.spec.host}{"\n"}'
----
...
[source,bash,subs="attributes+,+macros"]
----
oc get route -n {user}-prod canary -o jsonpath='{"https://"}{.spec.host}{"\n"}'
----
...
[source,bash,subs="attributes+,+macros"]
----
oc get route -n {user}-prod all -o jsonpath='{"https://"}{.spec.host}{"\n"}'
----
...
.link:https://github.com/OpenShiftDemos/argo-rollouts-workshop/blob/main/content/modules/ROOT/examples/canary-analysis/base/rollout.yaml[./canary-analysis/base/rollout.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
...
[source,bash,subs="attributes+,+macros"]
----
kustomize build ./canary-analysis/base | sed "s/%SUB_DOMAIN%/$SUB_DOMAIN/" | sed "s/%USER%/%USERNUM%/" | oc apply -n {user}-prod -f -
----
