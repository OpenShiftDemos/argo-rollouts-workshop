...
what we saw in the previous module, the analysis button will have a blue button while it is executing
which then goes green when it has completed successfully or red if it failed.
