...
Argo Rollouts provides a link:https://kubernetes.io/docs/reference/kubectl/[kubectl,window='_blank'] extension to support
working with rollouts. link:https://argo-rollouts.readthedocs.io/en/stable/installation/#kubectl-plugin-installation[Instructions, window='blank']
