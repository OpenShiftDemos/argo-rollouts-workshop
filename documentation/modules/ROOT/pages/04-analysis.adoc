...
If you expand the Analysis section, you will see at least one metric test has failed:

image::argo-rollouts-analysis-failed-details.png[]

You can hover the mouse over the failed analysis to see the details.
